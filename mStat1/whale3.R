...
gamma.mle = nlm(lik,p.start) 

alpha.hat.mle = gamma.mle$estimate[1]
alpha.hat.mle

lambda.hat.mle = gamma.mle$estimate[2]
lambda.hat.mle
...
for(i in 1:B){
	...
	alpha.star.mle[i] = gamma.mle$estimate[1]	# alpha
	lambda.star.mle[i] = gamma.mle$estimate[2]	# lambda
